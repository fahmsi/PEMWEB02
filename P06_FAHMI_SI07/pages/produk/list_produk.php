            ...
            ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="btn btn-secondary" href="edit_produk.php?idedit=<?=$row['id']?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>
                            <a class="btn btn-danger" href="../../proces/produk/delete_produk.php?iddel=<?=$row['id']?>"
